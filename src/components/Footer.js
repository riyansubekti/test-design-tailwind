    ...
    <div className="relative w-full">
      ...
      <div className='px-[50px] border-t border-b border-solid border-[#171717] bg-[#121212]'>
        ...
        <div className="flex w-full h-full max-w-[1400px] mx-auto justify-between flex-wrap">
          {/* footer-wrp-3 */}
          <div className="w-2/5 h-full pt-[60px] pb-[55px]">
            {/* footer-txt-wrp-1 */}
            <div className="relative">
              {/* class="footer-txt-3" */}
              <div className="relative z-[1] w-[350px] font-sohemono-buch text-white leading-[26px] tracking-[0.14px]">
              ...
              <a href="/" className="flex w-[300px] mb-[58px] justify-start items-center border-none text-[#b8b8b8]">
                {/* footer-link-txt-1 */}
          ...
          {/* footer-wrp-4 */}
          <div className="flex w-3/5 h-full pt-[60px] pb-[55px] justify-start items-stretch">
            {/* footer-wrp-5 */}
      ...
      {/* footer-base-1 */}
      <div className="relative w-full h-14 px-[50px] bg-[#121212]">
        {/* footer-base-wrp-1 */}
        <div className="flex w-full h-full max-w-[1400px] mx-auto justify-between flex-wrap">
          {/* footer-base-wrp-2 */}
          ...
          {/* footer-base-wrp-3 */}
          <div className="flex h-full justify-end flex-wrap items-center">
