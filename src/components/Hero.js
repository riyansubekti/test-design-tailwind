  ...
  return (
    ...
    <div className="bg-[#050505] relative w-full px-[50px] border-t border-solid border-[#1c1c1c]">
      ...
      <div className="w-full h-full max-w-[1400px] mx-auto justify-between items-start">
        {/* hero-wrp-1 */}
        <div className="flex overflow-visible w-full flex-row justify-between flex-wrap items-stretch auto-cols-fr grid-cols-2 grid-rows-2 object-fill">
          {/* hero-wrp-2 */}
          <div className="relative w-[42%] py-[5%] pr-[2.5%]">
            {/* hero-hd-1 */}
            <h1 className="mb-4 text-white text-[32px] leading-[38px] font-bold">
              Timeless insights for business and life.
            </h1>
            {/* hero-para-1 */}
            <p className="mb-6 text-white text-xl leading-[30px] font-medium tracking-[.24px]">
            ...
            {/* hero-btn-wrp-1 */}
            <div className="flex w-[388px] mb-3 justify-between flex-wrap items-center">
              {/* hero-btn-1 w-button kurang transition dan border-image*/}
              <a href="/" className="relative flex h-11 justify-center items-center bg-[rgb(20,20,20)] font-sohemono text-white text-sm leading-5 tracking-[0.14px] pb-[2px] px-7 border border-solid border-[rgba(255,255,255,0.06)] rounded-lg no-underline cursor-pointer">Start Here</a>
              <a href="/" className="relative flex h-11 justify-center items-center bg-[rgb(20,20,20)] font-sohemono text-white text-sm leading-5 tracking-[0.14px] pb-[2px] px-7 border border-solid border-[rgba(255,255,255,0.06)] rounded-lg no-underline cursor-pointer">Listen to the Podcast</a>
            </div>
          </div>
          {/* hero-wrp-3 */}
          <div className="animasi-bergerak relative flex w-1/2 -mt-20 -mb-[60px] justify-between items-center object-fill">
