...
const Header = () => {
  ...
  return (
    <div>
      {/* nav-menu */}
      <div className="relative z-10 flex w-full h-14 mt-[50px] px-4 justify-center items-stretch bg-body">
        {/* nav-border-2 */}
        ...
        {/* menu-grid-1 */}
        <div className="flex w-full max-w-[1400px] justify-between auto-cols-fr grid-cols-4 grid-flow-row">
          {/* menu-link-1 kurang transition*/}
          <a href="/" className="relative w-1/5 h-full py-[18px] justify-center items-center bg-transparent text-white no-underline cursor-pointer border-none hover:text-[#f90]">
            {/* menu-link-txt-1 */}
      ...
      <div className="fixed left-0 right-0 top-0 bottom-auto z-[100] overflow-hidden w-full h-[50px]">
        ...
        <div className="relative z-[1] flex w-full h-[50px] px-4 justify-center items-stretch border-b border-solid border-[#1c1c1c] bg-[hsla(0,0%,9%,.92)]">
          ...
          {/* nav-wrp-3 */}
          <div className="absolute left-auto top-0 right-4 bottom-0 flex h-full justify-end items-center">
            {/* subscribe-link-1 */}
